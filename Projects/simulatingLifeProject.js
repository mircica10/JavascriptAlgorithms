...
World.prototype.toString = function() {
  var output = "";
  for( var y = 0; y < this.grid.heigth; ++y){
...
World.prototype.checkDestination = 
...
function WallFallower() {
  this.dir = "s";
}
WallFallower.prototype.act = function(view) {
  var start = this.dir;
...
var valleyWithSmartPlantEaters = new LifelikeWorld(plan, {"#": Wall, "O": SmartPlantEater, "*": Plant});
...
function runWorld(){
  ...
  console.log(valleyWithPredators.toString());
  //console.clear();
}

function testWorld(numberOfTimes, miliseconds){
  if(numberOfTimes < 0) 
    return;
  runWorld();
  setTimeout(() => testWorld(numberOfTimes - 1, miliseconds), miliseconds);
}
